...
public class ProjectileMechanic extends DirectionMechanic {
    ...
    private final CustomSkill onHitBlock, onHitEntity, onTick;
    ...
    public ProjectileMechanic(ConfigObject config) {
        ...
        onHitEntity = config.contains("hit_entity") ? MythicLib.plugin.getSkills().getSkillOrThrow(config.getString("hit_entity")) : null;
