...
public class MechanicQueue {
    ...
    public MechanicQueue(SkillMetadata meta, Skill skill) {
        this.meta = meta;
    ...
    public void next() {
        ...
        if (mechanic instanceof DelayMechanic)
            ...
            try {
                ...
                MythicLib.plugin.getLogger().log(Level.WARNING, "Could not execute mechanic n" + counter + " from skill '" + skill.getName() + "': " + exception.getMessage());
            }
    }
}
